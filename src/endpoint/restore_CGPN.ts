...
const newRPC = new ethers.JsonRpcProvider('https://rpc2.conet.network')
const managerWallet = new ethers.Wallet(masterSetup.conetFaucetAdmin[0], newRPC)
const CGPNsV5addr = '0xF34798C87B8Dd74A83848469ADDfD2E50d656805'
