...
const CoNETMainChainRPC = 'https://publicrpc.conet.network'
...
//		curl -X POST -H 'Content-Type: application/json' -d '{"jsonrpc":"2.0","id":"json","method":"add","params":[1, 2]}' https://publicrpc.conet.network
//		curl -X POST -H "Content-Type: application/json" -d '{"jsonrpc":"2.0","id":1, "method":"getHealth"}' https://publicrpc.conet.network
