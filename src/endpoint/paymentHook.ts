...
const appleNotification = async (NotificationSignedPayload: string ) => {
	...
	try {
        ...
        return logger(`appleNotification got unverifyable NotificationSignedPayload!`, inspect(verifiedTransaction, false, 3, true))
