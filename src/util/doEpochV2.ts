...
const getLocalIPFS = async (block: string) => {
	...
	try {
		...
		logger(Color.red(`doEpochV2 getLocalIPFS ${path1} ${path2} Error!`))
		return null
	}
...
const CNTP_Transfer_Manager_freemining = new CNTP_Transfer_Manager(masterSetup.conetFaucetAdmin_1, 400)
